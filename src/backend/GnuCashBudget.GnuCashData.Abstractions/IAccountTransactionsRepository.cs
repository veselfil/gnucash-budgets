...
public interface IAccountTransactionsRepository
{
    ...
    Task WriteTransactionAsync(Account accountFrom, Account accountTo, Commodity commodity, Transaction transaction, CancellationToken cancellationToken = default);
}